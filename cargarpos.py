...
if not archivos:
    raise FileNotFoundError("❌ No se encontró ningún archivo que empiece con 'CORRECTA_' en la carpeta especificada.")

# Tomar el archivo más reciente por fecha de modificación
ruta_excel = max(archivos, key=os.path.getmtime)
print(f"📥 Leyendo archivo Excel detectado automáticamente: {ruta_excel}")

# Leer automáticamente la primera hoja del archivo Excel
...
print(f"✅ Hoja leída correctamente: {nombre_hoja}")
