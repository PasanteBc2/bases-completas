import pandas as pd # pip install  pandas openpyxl # manejo de datos y Excel
import glob # manejo de archivos
import os # manejo de rutas 
import sys  # manejo de sistema y salidas de error 
from sqlalchemy import create_engine  # motor de conexión a BD
from sqlalchemy.engine import URL # para crear URL de conexión
from sqlalchemy.exc import OperationalError # manejo de errores de conexión
import logging # para logging de información y errores 
