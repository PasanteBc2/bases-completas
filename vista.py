...
# Botones
crear_boton("Ejecutar DIGITAL", "#ECFF8C", "📘", lambda: ejecutar_script("digital"))
crear_boton("Ejecutar MIGRACION", "#8CEBE6", "💳", lambda: ejecutar_script("migracion"))
crear_boton("Ejecutar TRADICIONAL", "#C59FE9", "🏢", lambda: ejecutar_script("tradicional"))
